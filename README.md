...
Ю Условия:
Ю •    указан несуществующий путь
Ю Ожидаемый результат:
Ю •    файл не отслеживается
Ю •    ошибок выполнения нет
Ю Фактический результат:
Ю программа продолжает работу без исключений
Ю Case 6 — Изменение без изменения размера (ограничение системы)
Ю Условия:
Ю •    содержимое файла изменено, но размер совпадает
Ю Ожидаемый результат:
Ю событие может не фиксироваться
Ю Фактический результат:
Ю возможны пропуски при быстрых операциях (частично зависит от last_write_time)
...
<img src="https://drive.google.com/file/d/1QNGJwJ0HhRV4tqqhWywTtjcARjMWNWiW/view?usp=share_link" />
